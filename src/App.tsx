...
import { SessionContextProvider } from './components/auth/SessionContextProvider'; // Import the provider

function App() {
  return (
    <ThemeProvider defaultTheme="light" storageKey="vite-ui-theme">
      <Toaster richColors position="top-right" />
      <SessionContextProvider> {/* Wrap the Router with SessionContextProvider */}
        <Router>
          <Routes>
            {/* Public Route */}
