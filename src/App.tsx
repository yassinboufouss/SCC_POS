...
import ManualGiveawaysPage from "./pages/ManualGiveawaysPage"; // FIX: Use correct page name
import ProtectedRoute from './components/auth/ProtectedRoute'; // FIX: Correct path
