export const fr = {
  translation: {
    ...
    "search_members_by_name_code_phone": "Rechercher des membres par nom, code, ou téléphone...",
    ...
    "search_by_name_code_or_phone": "Rechercher par nom, code, ou téléphone",
    ...
    "delete_plan_confirmation": "Êtes-vous sûr de vouloir supprimer définitivement le plan d'adhésion '{{name}}' ? Cette action est irréversible et peut affecter les membres existants.",
    ...
    "security_settings_placeholder": "Les paramètres de changement de mot de passe et d'authentification à deux facteurs seront gérés ici.",
    ...
    "giveaway_management": "Émission Manuelle de Cadeaux",
    "giveaway_items_list": "Articles d'Inventaire ({{count}})",
    "issue_giveaway": "Émettre un Cadeau",
    "issue_giveaway_to_member": "Émettre un Cadeau à un Membre",
    "select_member_to_issue": "Sélectionner le Membre à Qui Émettre le Cadeau",
    "giveaway_issued_success": "Cadeau {{item}} émis avec succès à {{member}}.",
    "giveaway_issued_failed": "Échec de l'émission du cadeau.",
    "no_giveaway_items": "Aucun article d'inventaire trouvé correspondant à votre recherche.",
    "select_item_to_issue": "Sélectionner l'Article à Émettre",
    "item_stock": "Stock de l'Article",
    "item_is_giveaway_for": "Lié aux Plans:",
    "issue_item": "Émettre l'Article",
    ...
    "email_management": "Gestion de l'E-mail",
    ...
    "email_update_note": "Changer votre e-mail nécessite une confirmation via un lien envoyé à la nouvelle adresse.",
    "member_email": "e-mail du membre",
    ...
    "void_transaction_warning": "ATTENTION : Les changements d'adhésion (renouvellement/achat) ne sont PAS automatiquement annulés et doivent être gérés manuellement.",
    ...
    "transaction_void_success_with_warning": "Transaction ID {{id}} annulée. ATTENTION : Le statut d'adhésion pourrait nécessiter un ajustement manuel.",
    ...
    "period_totals": "Totaux de Période",
    "daily_breakdowns": "Répartitions Quotidiennes",
    "monthly_breakdowns": "Répartitions Mensuelles",
    "monthly_inventory_sales": "Ventes d'Inventaire (Mois)",
    "monthly_membership_sales": "Ventes d'Adhésion (Mois)",
    "today": "Aujourd'hui",
